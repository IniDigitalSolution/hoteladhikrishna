...
const facilities = [
  ['A/C', 'Air-Conditioned Rooms', 'Comfortable, well-maintained rooms to help you rest and recharge after a day of travel.'],
  ['⌁', 'Wi-Fi Connectivity', 'Stay connected for work, calls or everyday browsing with reliable Wi-Fi access throughout your stay.'],
  ['P', 'Parking', 'Convenient on-site parking for guests travelling to the city by their own vehicle.'],
  ...
  ['i', 'Front Desk Assistance', 'Our front desk team is available 24 hours a day to help with check-in, local information or any request during your stay — whenever you need it.'],
]
...
const gallery = [
  ...
  ['gallery-hotel-near-railway-station.jpeg', 'Hotel Exterior at Night', 'Hotel'],
  ['gallery-best-hotel-bus-stand.jpeg', 'Hotel Entrance & Lobby', 'Hotel'],
  ['gallery-adhikrishna-arcade-bus-stand.jpeg', 'Lobby & Elevator', 'Hotel'],
  ['gallery-hotel-near-bus-stand.jpeg', 'Hotel Signage Near Bus Stand', 'Hotel'],
  ['gallery-hotel-stay-railway-station-road.jpeg', 'Spacious Room Interior', 'Rooms'],
  ['gallery-cheap-room-railway-station.jpeg', 'Twin Bed Room Interior', 'Rooms'],
  ['gallery-hotel-central-bus-stand.jpeg', 'Comfortable Seating Area', 'Rooms'],
...
function FloatingWhatsApp() {
  return <a className="floating-whatsapp" href={whatsappUrl('Hello, I would like to check room availability at Hotel Adhikrishna Arcade.')} target="_blank" rel="noreferrer" aria-label="Chat with Hotel Adhikrishna Arcade on WhatsApp"><span className="wa-icon" aria-hidden="true"><svg viewBox="0 0 32 32" focusable="false"><path d="M16.04 3.2c-7.05 0-12.78 5.67-12.78 12.66 0 2.23.59 4.4 1.7 6.31L3.16 28.8l6.84-1.78a12.87 12.87 0 0 0 6.03 1.51h.01c7.05 0 12.79-5.68 12.79-12.66S23.09 3.2 16.04 3.2Zm0 23.2h-.01c-1.9 0-3.76-.51-5.39-1.48l-.39-.23-4.06 1.06 1.08-3.92-.26-.4a10.43 10.43 0 0 1-1.62-5.57c0-5.82 4.78-10.55 10.65-10.55 2.84 0 5.51 1.1 7.52 3.09a10.43 10.43 0 0 1 3.12 7.46c0 5.82-4.77 10.54-10.64 10.54Zm5.84-7.89c-.32-.16-1.9-.93-2.2-1.04-.29-.11-.5-.16-.72.16-.21.32-.82 1.04-1.01 1.25-.19.21-.37.24-.69.08-.32-.16-1.35-.49-2.57-1.58-.95-.84-1.59-1.88-1.78-2.2-.19-.32-.02-.49.14-.65.15-.14.32-.37.48-.56.16-.19.21-.32.32-.53.11-.21.05-.4-.03-.56-.08-.16-.72-1.72-.98-2.35-.26-.62-.52-.53-.72-.54h-.61c-.21 0-.56.08-.85.4-.29.32-1.12 1.09-1.12 2.66 0 1.57 1.15 3.09 1.31 3.3.16.21 2.27 3.43 5.49 4.81.77.33 1.37.53 1.84.68.77.24 1.47.21 2.02.13.62-.09 1.9-.77 2.17-1.52.27-.75.27-1.39.19-1.52-.08-.13-.29-.21-.61-.37Z" /></svg></span><span className="wa-label">Chat on WhatsApp</span></a>
}
